...
to fire
  ask ISSs [
    set rvx rvx + (10000 * sin heading) / rMass  ;; rmass is the ISS mass 
    set rvy rvy + (10000 * cos heading) / rMass ]
  set fuelUsed fuelUsed + 10
end
   ...
   if alive? [
     ...
     ask ISSs
       [ifelse ISS_Direction = "Forward" 
        ...
        if s <  10 [ set s 10 ]    ;; but don't let it get smaller than 4     
