...
Globals [scale eRadK gHP mOffP ixP iyP iSizeP cycleCount rX rY rVX rVY rMass b1 b2 b3 b4 mX mY alive? Gm Gmm running? oldLS oldMH oldIScale launchHeight time nextPuffTime puffInterval fuelUsed EscapeSpeed speed orbits oldAngle]
...
to placeArrows ;; keep the arrows up-to-date with changes in the sliders
  set launchHeight 350  ;; height of ISS
  ask arrow 2 [
...
to stepISS
  ...
  ifelse  r > eRadK 
    [ let ax 0
      ...
      if angle < oldAngle [set orbits orbits + 1]
      set oldAngle angle
...
to fire
  ask ISSs [
    ...
    set rvy rvy + (1000 * thruster_impulse * cos heading) / rMass ]
